...
_DEFAULT_CASES = Path("research/data/cases")
...
def main(
    ...
    validate_only: Annotated[bool, typer.Option("--validate-only", help="Validate inputs without calling an LLM")] = False,
) -> None:
    ...
    if validate_only:
        typer.echo(f"Validated baseline inputs for case={case}")
        return

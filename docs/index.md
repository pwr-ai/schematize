<div style="text-align: center; padding: 2.5rem 0 1.5rem;">
  ...
  <div style="display: flex; align-items: center; justify-content: center; gap: 1.5rem; margin-top: 1rem;">
    <img src="assets/logo_dep.svg" alt="Department of Artificial Intelligence logo" style="height: 48px; background: #fff; padding: 4px 8px; border-radius: 4px;">
    <img src="assets/logo_pwr.png" alt="Wrocław University of Science and Technology logo" style="height: 40px; background: #fff; padding: 4px 8px; border-radius: 4px;">
  </div>
</div>
